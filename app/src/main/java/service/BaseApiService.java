...
public interface BaseApiService {
    ...
    Call<ResponseBody> updateProfile(@Field("kodeUser") String kodeUser,
    ...
    Call<ResponseBody> saveJudul(@Field("userid") String id,
                                 ...
                                 @Field("kodeBidang") Integer kodeBidang);
    ...
    @FormUrlEncoded
    @POST("updateVerifikasiUser.php")
    Call<ResponseBody> updateUserLogin(@Field("userId") String id,
                                       @Field("cstat") String stat);
    ...
    @Multipart
    @POST("uploadSempro.php?apicall=upload")
    Call<ResponseBody> uploadSempro(@Part("image\"; filename=\"myfile.jpg\" ") RequestBody file,
    ...
    @FormUrlEncoded
    @POST("updateFileSempro.php")
    Call<ResponseBody> updateUploadFileSempro(@Field("userId") String idMhs,
                                              @Field("fileName") String nama,
                                              @Field("tglNow") String tglNow);
