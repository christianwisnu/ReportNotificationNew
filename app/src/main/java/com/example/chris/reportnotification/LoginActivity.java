...
public class LoginActivity extends AppCompatActivity {
    ...
    Button btnLogin;
    @BindView(R.id.btnLoginClearUser)
    Button btnClearUser;
    @BindView(R.id.input_layout_login_userid)
    TextInputLayout inputLayoutUser;
    @BindView(R.id.input_layout_login_sandi)
    TextInputLayout inputLayoutPasw;
    @BindView(R.id.eLoginUserID)
    EditText eUserID;
    @BindView(R.id.eLoginSandi)
    EditText ePassword;
    ...
    private void requestLogin(String id, String pasw) {
        pDialog.setMessage("Login ...\nHarap Tunggu");
        showDialog();
        mApiService.loginRequest(id, pasw)
